# 💫 About Me:
Bilingual Electronics Engineer with a Master's degree in Artificial Intelligence, I have over 3 years of experience in IT, with a current focus on bridging development and operations (DevOps/MLOps). I possess a good understanding of databases including MySQL, PostgreSQL, and MongoDB. Proficient in AWS Console operations, I manage users, establish policies, and review logs. I am currently an SME in AWS Data Pipelines and oversee services such as Route 53, Elastic Beanstalk, EC2, S3, and RDS. I am familiar with basic Terraform practices for infrastructure as code and have some experience using GitLab. I regularly address technical issues via Jira and monitor systems with OpsGenie and NagiosXI. In my master's research, I am primarily focused on image steganography using image processing techniques and steganalysis with CNN. Additionally, my master's studies have provided me with a solid understanding and expertise in Machine Learning, Deep Learning, Image Processing, and Natural Language Processing.
